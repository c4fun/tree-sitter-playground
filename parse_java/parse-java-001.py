...
def traverse(node):
    ...
    with open('001-java-treesitter-parse-result-loc.txt', 'a') as f:
...
code_file = "/home/richardliu/code/github.com/rvesse/airline/airline-prompts/src/main/java/com/github/rvesse/airline/prompts/Prompt.java"
# Java 代码片段，从文件中读取
